package com.ultralytics.ultralytics_yolo.camera_preview;
...
public class TfliteCameraPreview extends CameraPreview {
    ...
    public TfliteCameraPreview(Context context) {

...
//import com.ultralytics.ultralytics_yolo.classify.ClassifiedObject;
//import com.ultralytics.ultralytics_yolo.classify.Classifier;
//import com.ultralytics.ultralytics_yolo.classify.TfliteClassifier;
//import com.ultralytics.ultralytics_yolo.detect.Detector;
//import com.ultralytics.ultralytics_yolo.detect.TfliteDetector;
//import com.ultralytics.ultralytics_yolo.models.LocalModel;
//import com.ultralytics.ultralytics_yolo.models.RemoteModel;
...
//
//                for (ClassifiedObject classifiedObject : result) {
//                    Map<String, Object> objectMap = new HashMap<>();
//
//                    objectMap.put("confidence", classifiedObject.confidence);
//                    objectMap.put("label", classifiedObject.label);
...
//            tfliteCameraPreview.setCameraFacing(direction);
//        }
//    }
//
...
//
//    public MethodCallHandler(BinaryMessenger binaryMessenger, Context context, TfliteCameraPreview tfliteCameraPreview) {
...
//
//                yoloModel = new LocalModel(task, format, modelPath, metadataPath);
//                break;
//            case "remote":
//                String modelUrl = (String) model.get("modelUrl");
//
//                yoloModel = new RemoteModel(modelUrl, task);
//                break;
//        }
//
//        try {
...
//        tfliteCameraPreview.setPredictorFrameProcessor(predictor);
//    }
//
...
//                final String imagePath = (String) imagePathObject;
//                Bitmap bitmap = BitmapFactory.decodeFile(imagePath);
//                final List<ClassifiedObject> res = (List<ClassifiedObject>) predictor.predict(bitmap);
//
//                List<Map<String, Object>> objects = new ArrayList<>();
//                for (ClassifiedObject classifiedObject : res) {
//                    Map<String, Object> objectMap = new HashMap<>();
//
//                    objectMap.put("confidence", classifiedObject.confidence);
//                    objectMap.put("index", classifiedObject.index);
//                    objectMap.put("label", classifiedObject.label);
//                    objects.add(objectMap);
//                }
//
...
//            tfliteCameraPreview.setScaleFactor(factor);
//        }
//    }
//}
